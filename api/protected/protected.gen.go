// Package protected provides primitives to interact with the openapi HTTP API.
//
...
func RegisterHandlersWithOptions(router EchoRouter, si ServerInterface, options RegisterHandlersOptions) {
	...
	router.GET(options.BaseURL+"/channels", wrapper.GetChannels, options.OperationMiddlewares["getChannels"]...)
